...
// Use runtime config if available, then build-time env var, then fallback to localhost
const API_BASE_URL = window.ENV?.REACT_APP_API_URL || process.env.REACT_APP_API_URL || 'http://localhost:3001/api';
