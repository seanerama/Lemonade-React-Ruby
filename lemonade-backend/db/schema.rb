...
ActiveRecord::Schema[8.0].define(version: 2025_10_20_223254) do
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "username"
    t.index ["email"], name: "index_players_on_email", unique: true, where: "((email IS NOT NULL) AND ((email)::text <> ''::text))"
